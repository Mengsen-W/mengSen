 ...
 * @LastEditTime: 2022-03-03 12:53:03
 * @FilePath: /mengsen/mengsen/base/Logging.cpp
 */
...
#include "mengsen/base/TimeZone.h"
...
void Logger::Impl::formatTime() {
  Timestamp::Time_uint64_t microSecondsSinceEpoch = time_;
  ...
  std::string microseconds =
      Timestamp::convert<Timestamp::Time_uint64_t, std::string>(
