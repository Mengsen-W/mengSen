/*
 * @Date: 2022-03-07 19:43:06
 * @Author: Mengsen Wang
 * @LastEditors: Mengsen Wang
 * @LastEditTime: 2022-03-09 14:51:05
 * @FilePath: /mengsen/mengsen/net/Connector.cpp
 */
...
void Connector::handleWrite() {
  ...
  if (state_ == kConnecting) {
    int sockfd = removeAndResetChannel();
    // connected already and remove channel do not
    // use this channel, but the socket fd pass to TcpConnect
