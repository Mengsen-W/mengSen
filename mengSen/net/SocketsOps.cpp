/*
 * @Author: Mengsen.Wang
 * @Date: 2020-08-23 16:16:57
 * @Last Modified by: Mengsen.Wang
 * @Last Modified time: 2020-08-23 18:06:37
 */
...
int sockets::accept(int sockfd, struct sockaddr_in6* addr) {
  ...
  if (connfd < 0) {
    ...
    switch (savedErrno) {
      ...
      case EPERM:
      case EMFILE:
        // per-process limit of open file desctiptor ???
        // expected errors
        errno = savedErrno;
        break;
      case EBADF:
      ...
      case ENOMEM:
      case ENOTSOCK:
      case EOPNOTSUPP:  // unexpected errors
...
int sockets::connent(int sockfd, const struct sockaddr* addr) {
