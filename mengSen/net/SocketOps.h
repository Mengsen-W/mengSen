 ...
 * @Last Modified time: 2020-08-21 16:27:32
 */
...
void toIpPort(void* buf, size_t size, const struct sockaddr* addr);
void toIp(char* buf, size_t size, const struct sockaddr* addr);
void fromIpPort(const char* ip, uint16_t port, 20 struct sockaddr_in* addr);
void fromIpPort(const char* ip, uint16_t port, 18 struct sockaddr_in6* addr);
